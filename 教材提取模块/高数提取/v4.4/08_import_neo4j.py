# -*- coding: utf-8 -*-
"""
v4.4 Step 8B: import the final approved KG package into Neo4j.
...
FINAL_DIR = SCRIPT_DIR / "中间产物" / "step8a_final_package"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Import v4.4 Step 8A final KG package into Neo4j.")
...
def write_report(
    ...
    lines = [
        "# v4.4 Step 8 Neo4j Import Report",
        "",
