"""
v4.4 Step 3C: convert ExampleFrame records into application-layer candidates.
...
def main() -> None:
    ...
    report_lines = [
        "# v4.4 Step 3C Example Application Conversion Report",
        "",
        f"- frames: {len(frames)}",
        f"- Step 3E audited core node names indexed: {len(core_index)}",
