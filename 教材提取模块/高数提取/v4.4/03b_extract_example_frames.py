"""
v4.4 Step 3B: extract ExampleFrame records from example sections.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract v4.4 ExampleFrame records.")
...
def split_example_section(section: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    if section.get("parent_section_node_id") and section.get("example_label_hint"):
        return [section]
...
def write_report(
    ...
    lines = [
        "# v4.4 Step 3B ExampleFrame Report",
        "",
...
def main() -> None:
    ...
    model = args.model or llm_config.get("example_model") or llm_config.get("node_model") or llm_config.get("default_model", "GPT-5.4")
