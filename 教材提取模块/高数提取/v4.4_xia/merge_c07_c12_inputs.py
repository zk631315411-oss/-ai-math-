...
MID = ROOT / "中间产物"
SOURCES = [
    ("C07-C10_UNIFIED_TWO_LEVEL_VERIFIED", MID / "chapter_batch_c07_c10_unified_rerun_20260626"),
    ("C11-C12_BATCH", MID / "chapter_batch_c11_c12"),
]
OUT = MID / "chapter_batch_c07_c12_unified_20260626"
...
def main() -> None:
    ...
    manifest: dict = {
        ...
        "merged_files": {},
        "notes": [
            "C07-C10 source is the verified unified rerun with two-level knowledge groups validated in Neo4j and Step 9.",
            "C11-C12 source is the fresh two-chapter batch completed through Step 8A before this merge.",
            "This script merges Step 5 input artifacts, then downstream Step 5-8 must be rerun for global normalization, review, merge plans, and final KnowledgeGroup assembly.",
        ],
    }
