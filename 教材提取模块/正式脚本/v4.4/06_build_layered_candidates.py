"""
v4.3 Step 6: build layered candidate packages.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build v4.3 phase-one KG layers from Step 5 outputs.")
...
def main() -> None:
    ...
    write_report(report_path, explicit_nodes, explicit_edges, app_nodes, app_edges, review_nodes, review_edges, rule_cases, review_rule_cases, rejected)
