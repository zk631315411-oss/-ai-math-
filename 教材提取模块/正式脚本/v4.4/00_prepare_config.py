...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--default-model", default=os.environ.get("DEEPSEEK_FLASH_MODEL", "deepseek-chat"))
    parser.add_argument("--high-risk-model", default=os.environ.get("DEEPSEEK_HIGH_RISK_MODEL", "deepseek-chat"))
    parser.add_argument("--base-url", default=os.environ.get("DEEPSEEK_API_BASE", "https://api.deepseek.com/v1"))
